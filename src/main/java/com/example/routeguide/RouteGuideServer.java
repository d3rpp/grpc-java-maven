...
/**
 * A simple gRPC server that serves the RouteGuide service
 */
public class RouteGuideServer {
	public static final Logger logger = Logger.getLogger(RouteGuideServer.class.getName());
	...
	public void start() throws IOException {
		server.start();
		logger.info("Server started, listening on grpc://[::1]:" + port);
	...
	/** Stop serving requests and shutdown server */
	...
	public static class RouteGuideService extends RouteGuideGrpc.RouteGuideImplBase {
		...
		public final ConcurrentMap<Point, List<RouteNote>> routeNotes = new ConcurrentHashMap<Point, List<RouteNote>>();
		 ...
		 * @param responseObserver the observer that will receive the feature at the
		 *                         requested point.
		 */
		@Override
		 ...
		 * number of points,
		 * number of known features visited, total distance traveled, and total time
		 * spent.
		 *
		...
		public StreamObserver<Point> recordRoute(final StreamObserver<RouteSummary> responseObserver) {
			...
			return new StreamObserver<Point>() {
				...
				public void onNext(Point point) {
					logger.info("Got streamed request");
				...
				public void onCompleted() {
					logger.info("Completed Stream Request");
		...
		public StreamObserver<RouteNote> routeChat(final StreamObserver<RouteNote> responseObserver) {
			logger.info("started stream request");
			return new StreamObserver<RouteNote>() {
				@Override
				public void onNext(RouteNote note) {
					logger.info("Got streamed request data: " + note.getMessage());
				...
				@Override
				public void onCompleted() {
					logger.info("Completed streamed request");
					responseObserver.onCompleted();
				}
			};
		}
		 ...
		 * @return The feature object at the point. Note that an empty name indicates no
		 *         feature.
		 */
